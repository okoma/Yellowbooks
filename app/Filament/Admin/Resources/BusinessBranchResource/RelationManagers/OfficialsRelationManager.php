<?php
// ============================================
// OfficialsRelationManager for BusinessBranchResource
// app/Filament/Admin/Resources/BusinessBranchResource/RelationManagers/OfficialsRelationManager.php
// ============================================
...
class OfficialsRelationManager extends RelationManager
{
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->modifyQueryUsing(fn($query) => $query->with(['business', 'businessBranch']))
            ->columns([
